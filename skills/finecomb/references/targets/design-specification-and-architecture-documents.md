...
| Turning dimensions into questions | Use the [root-cause facets](../facets/index.md), the 46 dimensions and the relevant specialties as questions about the design; note that the conclusions are at the design level and the implementation still needs to be checked |
