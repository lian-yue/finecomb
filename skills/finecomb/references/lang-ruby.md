...
| Mass assignment | Request parameters are assigned directly to a model (see "automatic field binding" in [28](dimensions/28-authorization-and-access-control.md)) |
