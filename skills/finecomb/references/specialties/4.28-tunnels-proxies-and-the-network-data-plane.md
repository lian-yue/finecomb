...
| Real-time media and relays | Can relays (TURN) for real-time communication such as WebRTC be used as open proxies to reach the internal network? Do ICE candidates leak internal addresses? Validity period and scope of relay credentials. Does signaling (WebRTC signaling, SIP and similar) authenticate who may start, join, transfer or redirect a session? |
