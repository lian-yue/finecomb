...
| Multiprocessing | Using the `fork` start method in a multithreaded process may deadlock; the default start method changes with platform and version (see "fork and threads" in [18](dimensions/18-concurrency-and-memory-model.md)) |
