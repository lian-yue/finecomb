...
- [四、按目标类型追加的专项](references/specialties/index.md)
  - 通信：[4.1 网络与连接](references/specialties/4.1-networking-and-connections.md)｜[4.2 协议与帧解析](references/specialties/4.2-protocols-and-frame-parsing.md)｜[4.3 解码不受信任的外部数据](references/specialties/4.3-decoding-untrusted-external-data.md)｜[4.21 出站请求与服务端请求伪造](references/specialties/4.21-outbound-requests-and-server-side-request-forgery.md)｜[4.28 隧道、代理与网络数据面](references/specialties/4.28-tunnels-proxies-and-the-network-data-plane.md)｜[4.62 DNS 服务器与解析器](references/specialties/4.62-dns-servers-and-resolvers.md)｜[4.63 电信信令与短信](references/specialties/4.63-telecom-signaling-and-sms.md)｜[4.77 邮件服务器与邮件处理](references/specialties/4.77-mail-servers-and-mail-handling.md)
  - 身份：[4.4 加密与凭据](references/specialties/4.4-cryptography-and-credentials.md)｜[4.5 认证、会话与令牌](references/specialties/4.5-authentication-sessions-and-tokens.md)｜[4.46 联合身份与单点登录](references/specialties/4.46-federated-identity-and-single-sign-on.md)｜[4.61 证书颁发机构与 PKI 运维](references/specialties/4.61-certificate-authorities-and-pki-operations.md)｜[4.64 端到端加密通信](references/specialties/4.64-end-to-end-encrypted-messaging.md)｜[4.75 生物识别与身份核验](references/specialties/4.75-biometrics-and-identity-verification.md)
  - 数据：[4.6 缓存与存储](references/specialties/4.6-caching-and-storage.md)｜[4.7 数据库与查询](references/specialties/4.7-databases-and-queries.md)｜[4.8 文件系统与路径](references/specialties/4.8-file-systems-and-paths.md)｜[4.37 数据处理、批处理与机器学习](references/specialties/4.37-data-processing-batch-jobs-and-machine-learning.md)｜[4.53 搜索、索引与检索](references/specialties/4.53-search-indexing-and-retrieval.md)｜[4.54 同步、协作与离线客户端](references/specialties/4.54-sync-collaboration-and-offline-clients.md)｜[4.67 位置、在线状态与个人信息可见性](references/specialties/4.67-location-presence-and-visibility-of-personal-data.md)｜[4.73 备份、归档与灾难恢复](references/specialties/4.73-backup-archive-and-disaster-recovery.md)｜[4.76 健康数据与医疗互通](references/specialties/4.76-health-data-and-medical-interoperability.md)
  ...
  - 系统与平台：[4.30 操作系统接口、系统调用与描述符](references/specialties/4.30-os-interfaces-system-calls-and-descriptors.md)｜[4.32 跨语言边界与本地扩展](references/specialties/4.32-cross-language-boundaries-and-native-extensions.md)｜[4.35 客户端应用、扩展与自动更新](references/specialties/4.35-client-apps-extensions-and-auto-update.md)｜[4.36 嵌入式、固件与实时约束](references/specialties/4.36-embedded-firmware-and-real-time-constraints.md)｜[4.51 可信执行环境与飞地](references/specialties/4.51-trusted-execution-environments-and-enclaves.md)｜[4.52 工业控制与信息物理安全](references/specialties/4.52-industrial-control-and-cyber-physical-safety.md)｜[4.66 硬件设计与硬件安全](references/specialties/4.66-hardware-designs-and-hardware-security.md)｜[4.68 容器运行时与隔离](references/specialties/4.68-container-runtimes-and-isolation.md)｜[4.78 沙箱与中介进程](references/specialties/4.78-sandboxes-and-broker-processes.md)
  - 特权与移动端：[4.47 本机特权组件与本地提权](references/specialties/4.47-local-privileged-components-and-local-privilege-escalation.md)｜[4.48 内核驱动、设备仿真与虚拟化](references/specialties/4.48-kernel-drivers-device-emulation-and-virtualization.md)｜[4.49 移动应用组件与进程间通信](references/specialties/4.49-mobile-app-components-and-inter-process-communication.md)｜[4.59 远程访问与设备管理](references/specialties/4.59-remote-access-and-device-management.md)
  - 交付：[4.33 构建脚本、持续集成与基础设施即代码](references/specialties/4.33-build-scripts-ci-and-infrastructure-as-code.md)｜[4.34 可发布的库、SDK 与包](references/specialties/4.34-publishable-libraries-sdks-and-packages.md)｜[4.69 包注册表与制品仓库](references/specialties/4.69-package-registries-and-artifact-repositories.md)｜[4.70 代码托管与版本控制](references/specialties/4.70-code-hosting-and-version-control.md)
  - 平台与安全工具：[4.56 插件、扩展与应用平台](references/specialties/4.56-plugin-extension-and-app-platforms.md)｜[4.58 多租户平台与用户内容托管](references/specialties/4.58-multi-tenant-platforms-and-hosting-of-user-content.md)｜[4.60 处理不可信内容的安全工具](references/specialties/4.60-security-tools-that-process-untrusted-content.md)
  - 业务与外发：[4.39 支付、账务与计费](references/specialties/4.39-payments-accounting-and-billing.md)｜[4.40 通知与外发消息](references/specialties/4.40-notifications-and-outbound-messages.md)｜[4.65 交易、交易所与撮合](references/specialties/4.65-trading-exchanges-and-order-matching.md)｜[4.71 网络游戏与多人服务器](references/specialties/4.71-online-games-and-multiplayer-servers.md)｜[4.72 流媒体、DRM 与内容分发](references/specialties/4.72-media-streaming-drm-and-content-delivery.md)
